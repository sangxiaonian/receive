package haipo.com.receive.presenter;
...
import haipo.com.receive.basic.CustomApplication;
import haipo.com.receive.http.HttpParams;
import haipo.com.receive.mode.AliPayMode;
...
import haipo.com.receive.utils.XmlUtils;
...
public class AliPayPresenter extends Subscriber<String> implements IAliPayPresenter {
    ...
    private Subscriber<String> query  = new Subscriber<String>() {
        @Override
    ...
    public void cancle(String tag) {
        ...
        if (!query.isUnsubscribed()) {
            query.unsubscribe();
        }

        if (cancle.isUnsubscribed()){
            cancle.unsubscribe();
        }
    }
        ...
        try {
            ...
            switch (function) {
                ...
                case HttpParams.PARAMS_QUERY:
                    JLog.e("---------结束"+ Utils.getStringDate("ss秒")+"----------------");
                    break;
            ...
            if ("10000".equals(response.code)){
                if (HttpParams.PARAMS_SCAN==function){
                    ...
                    view.showBar(mBitmap);
                    JLog.e("---------开始"+ Utils.getStringDate("ss秒")+"----------------");
